    ...
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/career-advice" className="text-gray-300 hover:text-white transition-colors">Career Advice</Link></li>
              <li><Link to="/my-jobs" className="text-gray-300 hover:text-white transition-colors">My Jobs</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/employer-help" className="text-gray-300 hover:text-white transition-colors">Employer Help Center</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">&copy; 2025 Teacher-Connect</p>
